...
<html lang="en-US">
	...
	<body class="home home-6">
					...
					<div class="col-lg-5">
						<div class="menu-contact">
							<div class="mobile-content">
								...
								<div class="mobile-address"> 40 Park Ave, Brooklyn, New York <br> 1-800-111-2222 <br> <a href="../../cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="690a06071d080a1d290c11080419050c470a0604">[email&#160;protected]</a></div>
								...
								<ul class="social-media">
									...
									<li><a class="social-email" href="../../cdn-cgi/l/email-protection#eecd" target="_blank">Email</a></li>
								</ul>
							</div>
						</div>
					</div>
		...
		<div id="wrap-content" class="page-content custom-page-template">
			...
			<!-- /SECTION 3 -->
			<!-- SECTION 4 -->
			<div id="home-section-6-4" class="section-holder home-section-6-4 parallax parallax05" style="background-image:url(images/pages/contact-page.jpg);">
				<div class="container">
					<div class="row">
					...
					<div class="row">
							...
							<div class="row margin-b50less">
								<div class="col-md-6 margin-b50">
									<div class="mt-img-scale margin-b15">
										<a href="home-6.html#"><img class="img-fluid radius10" src="images/team/team-1.jpg" alt=" " /></a>
									</div>
									<h5 class="margin-b10"> April Ryan</h5>
									<div class="team-position">Photographer</div>
									<ul class="social-media social-team">
										<li><a href="home-6.html#" target="_blank"><i class="fab fa-facebook-f"></i></a></li>
								...
								<div class="col-md-6 margin-b50">
									<div class="mt-img-scale margin-b15">
										<a href="home-6.html#"><img class="img-fluid radius10" src="images/team/team-2.jpg" alt=" " /></a>
									</div>
						...
						<div class="col-lg-5 order-mobi1 margin-bm50">
							<div class="margin-l50">
								...
								<p>Veri ubique cu eam, vero dicta ridens ei quo, ex putent menandri accommodare sed. Suscipit lobortis prodesset ut eam. Sale dicta dolore pri et, an aliquam albucius volutpat est.</p>
								<p>Ad graeci theophrastus, libris timeam sapientem. Pellentes faucibus sollicitudin ante,at porta felisrutrum eget. Sed ut nisl urna.</p>
							...
							<div class="foo-block">
								<div class="widget_text widget widget-footer">
									...
									<ul class="footer-contact">
										...
										<li><i class="far fa-envelope"></i><span><a href="../../cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="264549485247455266435e474b564a430845494b">[email&#160;protected]</a></span></li>
									</ul>
								</div>
							</div>
						</div>
						...
						<div class="col-lg-3 col-sm-6">
							<div class="foo-block foo-last">
								<div class="widget widget-footer">
									...
									<ul>
										<li><a href="home-6.html#">Facebook</a></li>
										<li><a href="home-6.html#">Twitter</a></li>
										<li><a href="home-6.html#">Instagram</a></li>
										<li><a href="home-6.html#">Youtube</a></li>
										<li><a href="home-6.html#">Vimeo</a></li>
									</ul>
								</div>
							</div>
						</div>
